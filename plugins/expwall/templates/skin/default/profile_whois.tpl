...
<h2 class="header-table">{$aLang.user_menu_profile_wall}</h2>
...
<form class="wall-submit">
    <textarea rows="4" id="wall-text" class="mce-editor markitup-editor input-text input-width-full js-wall-reply-parent-text" style="height: 100px;"></textarea>
