...
(function (a, b) {
    ...
    }}), a.extend(a.ui.draggable, {version:"1.8.24"}), a.ui.plugin.add("draggable", "connectToSortable", {start:function (b, c) {
    ...
    }}), a.extend(a.ui.droppable, {version:"1.8.24"}), a.ui.intersect = function (b, c, d) {
    ...
    }}), a.extend(a.ui.resizable, {version:"1.8.24"}), a.ui.plugin.add("resizable", "alsoResize", {start:function (b, c) {
    ...
    }}), a.extend(a.effects, {version:"1.8.24", save:function (a, b) {
    ...
    }}), a.extend(a.ui.accordion, {version:"1.8.24", animations:{slide:function (b, c) {
    ...
    }}), a.extend(a.ui.dialog, {version:"1.8.24", uuid:0, maxZ:0, getTitleId:function (a) {
        var b = a.attr("id");
    ...
    }}), a.extend(a.ui.tabs, {version:"1.8.24"}), a.extend(a.ui.tabs.prototype, {rotation:null, rotate:function (a, b) {
