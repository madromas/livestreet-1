	...
	<form id="ip-form" method="POST" enctype="multipart/form-data">
		...
		<div class="clearfix">
			<div class="ip-block">
				...
				<input type="text" id="filter_ip1_1" name="filter_ip[1][1]" value="{$_aRequest.filter_ip[1][1]}" size="30" maxlength="5" class="input-text input-feedback-ip js-cp" /> .
				<input type="text" id="filter_ip1_2" name="filter_ip[1][2]" value="{$_aRequest.filter_ip[1][2]}" size="30" maxlength="5" class="input-text input-feedback-ip js-cp" /> .
				<input type="text" id="filter_ip1_3" name="filter_ip[1][3]" value="{$_aRequest.filter_ip[1][3]}" size="30" maxlength="5" class="input-text input-feedback-ip js-cp" /> .
				<input type="text" id="filter_ip1_4" name="filter_ip[1][4]" value="{$_aRequest.filter_ip[1][4]}" size="30" maxlength="5" class="input-text input-feedback-ip js-cp" />
			</div>
			<div class="ip-block">
				...
				<input type="text" id="filter_ip2_1" name="filter_ip[2][1]" value="{$_aRequest.filter_ip[2][1]}" size="30" maxlength="5" class="input-text input-feedback-ip" /> .
				<input type="text" id="filter_ip2_2" name="filter_ip[2][2]" value="{$_aRequest.filter_ip[2][2]}" size="30" maxlength="5" class="input-text input-feedback-ip" /> .
				<input type="text" id="filter_ip2_3" name="filter_ip[2][3]" value="{$_aRequest.filter_ip[2][3]}" size="30" maxlength="5" class="input-text input-feedback-ip" /> .
				<input type="text" id="filter_ip2_4" name="filter_ip[2][4]" value="{$_aRequest.filter_ip[2][4]}" size="30" maxlength="5" class="input-text input-feedback-ip" />
			</div>
		</div>
		<p>
